...
version: 0.2.0
model_profile: pro
description: Identifica variables de control y acceso, redacta directrices de intervencion, propone implicaciones y agenda futura desde la teoria fundamentada. PRO. Fase 6d — Aplicabilidad. Parametrizado con tipo de patron.
input_state: theory, application_context, object_of_study
---
