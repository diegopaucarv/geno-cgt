...
```json
{
  ...
  "properties": {
    ...
    "operational_question": {
      "type": "string",
      "description": "Operational question for LLM agents during discovery. Follows the structure: 'How do [population] [processing_verb] their [pattern]?' SINGULAR (pattern noun is always singular), process-oriented, concise, guides observation of patterns. Use conjugated verb form when instructions are in an inflected language."
    },
    "rationale": {
      "type": "string",
