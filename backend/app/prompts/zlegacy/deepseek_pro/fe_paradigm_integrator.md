...
notes:
  - Produce senal booleana did_state_expand.
  ...
  - Si revela variacion genuinamente nueva → expandir.
  - F0.3.5: Recibe {object_of_study} para contextualizar el tipo de patron.
input_state: current_paradigm, new_incidents, code_name, code_definition, object_of_study
constraints:
